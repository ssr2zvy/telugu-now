...
Under **Display > Appearance > Control spacing**, a single 0-16 pixel slider adjusts the distance between the waveform, the timestamp, and the audio bar together (default 4px), applying regardless of magnifier order. **Reset control spacing** restores the default.
