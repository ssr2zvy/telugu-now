...
import { Activity, Ban, ChartNoAxesCombined, Database, Download, Gauge, Globe, History, Image, Layers, RotateCcw, SlidersHorizontal, Sparkles, Workflow } from 'lucide-react';
...
export const settingsGroups: Partial<Record<SettingsPage, SettingsPage[]>> = {
  index: ['sampling', 'diagnostic', 'playback', 'appearance', 'images', 'eons', 'blacklist', 'export', 'reset'],
